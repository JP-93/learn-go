...
// TranslationClient is the client API for Translation movies.
//
...
func (c *translationClient) Translate(ctx context.Context, in *TranslationInput, opts ...grpc.CallOption) (*TranslationOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.Translation/Translate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// TranslationServer is the server API for Translation movies.
...
// UnsafeTranslationServer may be embedded to opt out of forward compatibility for this movies.
...
func _Translation_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.Translation/Translate",
	}
...
// Translation_ServiceDesc is the grpc.ServiceDesc for Translation movies.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Translation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.Translation",
	...
	Metadata: "proto/v1/translation.proto",
}
